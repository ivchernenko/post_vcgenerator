...
abbreviation s where "s s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value \<equiv>
 (toEnv (reset (setVarAny s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value) Ctrl'))"


lemma VC12_R2_ind_proof: "toEnvP s0 \<and>
...
getPstate (setVarAny s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value) ERROR =
    Ctrl'goUp \<and>
   \<not> getVarBool (setVarAny s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton'value stuck_value)
       alarmButton' \<and>
  \<not> getVarBool (setVarAny s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value)
      stuck' \<and>
...
\<not> DELAY'TIMEOUT
   \<le> ltime
       (reset (setVarAny s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value) ERROR)
...
theorem proof_2_12: "VC12 inv2 env s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value"
 ...
 prefer 2
  ...
  subgoal premises prems for s1 s2
    ...
    subgoal for s4
      apply(rule exI[of _ s4])
      by simp
    using prems(2) prems(4) prems(6) prems(8) prems(10) prems(15) prems(13) prems(17) prems(18) apply -[1]
 ...
 "pred2 s1 s2 (s s0 userAtTop_value userAtBottom_value directionSwitch_value alarmButton_value stuck_value) s2"])
     apply(simp only: pred2_def)
     apply(drule impE)
    using prems(2) prems(4) prems(6) prems(8) prems(10) prems(13) prems(17) prems(18) substate_trans substate_refl
