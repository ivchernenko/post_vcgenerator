theory ExtraInv_VC64
  imports ExtraInv
begin

theorem extra_64: "VC64 extraInv env s0 temperature_value button1_value button2_value button3_value boilingButton_value "
  apply(unfold VC64_def extraInv_def)
  apply(rule impI)
  apply(erule conjE)
  apply(erule conjE)
