theory ExtraInv_VC65
  imports ExtraInv
begin

theorem extra_65: "VC65 extraInv env s0 temperature_value button1_value button2_value button3_value boilingButton_value "
  apply(unfold VC65_def extraInv_def)
  apply(rule impI)
  apply(erule conjE)
  apply(erule conjE)
