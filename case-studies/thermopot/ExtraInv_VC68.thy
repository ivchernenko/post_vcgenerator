theory ExtraInv_VC68
  imports ExtraInv
begin

theorem extra_68: "VC68 extraInv env s0 temperature_value button1_value button2_value button3_value boilingButton_value "
  apply(unfold VC68_def extraInv_def)
  apply(rule impI)
  apply(erule conjE)
  apply(erule conjE)
  subgoal premises prems
    ...
    subgoal premises ei
      ...
      apply(rule conjI)
      using ei(5) prems(1) toEnvP_imp_gtime_gt_0 apply simp
      apply(rule conjI)
