theory ExtraInv_VC69
  imports ExtraInv
begin

theorem extra_69: "VC69 extraInv env s0 temperature_value button1_value button2_value button3_value boilingButton_value "
  apply(unfold VC69_def extraInv_def)
  apply(rule impI)
  apply(erule conjE)
  apply(erule conjE)
