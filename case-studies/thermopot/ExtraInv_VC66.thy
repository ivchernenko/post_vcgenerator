theory ExtraInv_VC66
  imports ExtraInv
begin

theorem extra_66: "VC66 extraInv env s0 temperature_value button1_value button2_value button3_value boilingButton_value "
  apply(unfold VC66_def extraInv_def)
  apply(rule impI)
  apply(erule conjE)
  apply(erule conjE)
